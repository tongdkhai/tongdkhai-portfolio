...
Validator.isRequired = function (selector, message) {
    return {
        selector,
        test: function (value) {
            return value ? undefined : message || 'Please send your infomation'
        }
    };
};
...
Validator.isEmail = function (selector, message) {
    return {
        ...
        test: function (value) {
            ...
            return regex.test(value) ? undefined : message || 'Please fill your email in.'
        }
    };
};
Validator.minLength = function (selector, min, message) {
    return {
        selector,
        test: function (value) {
            return value.length >= min ? undefined : message || `Password is ay least ${min} characters.`;
        }
    };
};
Validator.isConformed = function (selector, getConformValue, message) {
    return {
        selector,
        test: function (value) {
            return value === getConformValue() ? undefined : message || 'Value is incorrect!'
        }
    }
}